...
input_data_tmp := DATASET('~thesis::ii::bigdata::people_reye_1000samples_x16_y26_normalized', value_record, CSV); 
...
- Experiment 
 ...
 Iteration #:        50
 Centroid # :         16
Total Cluster Time: 16:42.547
Convergence: 30 iteration out of 50
...
MyKMeans.Result();
OUTPUT(MyKMeans.Result(),, '~online::ii::bigdata::extractedkmeansweightreye1', OVERWRITE, CSV);
